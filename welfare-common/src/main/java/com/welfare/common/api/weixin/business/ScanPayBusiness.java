package com.welfare.common.api.weixin.business;
...
import com.welfare.common.api.weixin.common.Log;
import com.welfare.common.api.weixin.common.Signature;
import com.welfare.common.api.weixin.common.Util;
import com.welfare.common.api.weixin.common.report.ReporterFactory;
import com.welfare.common.api.weixin.common.report.protocol.ReportReqData;
import com.welfare.common.api.weixin.common.report.service.ReportService;
import com.welfare.common.api.weixin.protocol.pay_protocol.ScanPayReqData;
import com.welfare.common.api.weixin.protocol.pay_protocol.ScanPayResData;
import com.welfare.common.api.weixin.protocol.pay_query_protocol.ScanPayQueryReqData;
import com.welfare.common.api.weixin.protocol.pay_query_protocol.ScanPayQueryResData;
import com.welfare.common.api.weixin.protocol.reverse_protocol.ReverseReqData;
import com.welfare.common.api.weixin.protocol.reverse_protocol.ReverseResData;
import com.welfare.common.api.weixin.service.ReverseService;
import com.welfare.common.api.weixin.service.ScanPayQueryService;
import com.welfare.common.api.weixin.service.ScanPayService;
...
public class ScanPayBusiness {
	...
	public void run(ScanPayReqData scanPayReqData, ResultListener resultListener) throws Exception {
		...
		ReportReqData reportReqData = new ReportReqData(scanPayReqData.getDevice_info(), Configure.PAY_API, (int) (totalTimeCost), // 本次请求耗时
				scanPayResData.getReturn_code(), scanPayResData.getReturn_msg(), scanPayResData.getResult_code(), scanPayResData.getErr_code(), scanPayResData.getErr_code_des(), scanPayResData.getOut_trade_no(), scanPayReqData.getSpbill_create_ip());
