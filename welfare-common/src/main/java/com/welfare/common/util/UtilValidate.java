...
public class UtilValidate {
	 ...
	 *
	 * @param stPassed
	 *            a string representing a valuelink gift card
	 ...
	 *
	 * @param stPassed
	 *            a string representing a gift card
	 ...
	 *
	 * @param cc
	 *            - a string representing a credit card number; Sample number: 340000000000009(15 digits)
	 ...
	 *
	 * @param cc
	 *            - a string representing a credit card number; Sample number: 30000000000004(14 digits)
	 ...
	 *
	 * @param cc
	 *            - a string representing a credit card number; Sample number: 6011000000000004(16 digits)
	 ...
	 *
	 * @param cc
	 *            - a string representing a credit card number; Sample number: 201400000000009(15 digits)
	 ...
	 *
	 * @param cc
	 *            - a string representing a credit card number; Sample number: 3088000000000009(16 digits)
	 ...
	 *
	 * @param cc
	 *            - a string representing a credit card number; Sample number: 6331100000000096(16 digits)
	...
	public static boolean isswitch(String cc) {
		...
		if (((cc.length() == 16) || (cc.length() == 18) || (cc.length() == 19)) && (first4digs.equals("4903") || first4digs.equals("4905") || first4digs.equals("4911") || first4digs.equals("4936") || first6digs.equals("564182") || first6digs.equals("633110") || first4digs.equals("6333") || first4digs.equals("6759")))
			return isCreditCard(cc);
		return false;
	}
	...
	public static boolean isSolo(String cc) {
		...
		if (((cc.length() == 16) || (cc.length() == 18) || (cc.length() == 19)) && (first2digs.equals("63") || first4digs.equals("6767")))
			return isCreditCard(cc);
		return false;
	}
	 ...
	 *
	 * @param cc
	 *            - a string representing a credit card number; Sample number: 4175000000000001(16 digits)
	...
	public static boolean isVisaElectron(String cc) {
		...
		if ((cc.length() == 16) && (first6digs.equals("417500") || first4digs.equals("4917") || first4digs.equals("4913") || first4digs.equals("4508") || first4digs.equals("4844") || first4digs.equals("4027")))
			return isCreditCard(cc);
		return false;
	}
	...
	public static boolean isAnyCard(String ccPassed) {
		...
		if (!isCreditCard(cc))
			return false;
		if (isMasterCard(cc) || isVisa(cc) || isAmericanExpress(cc) || isDinersClub(cc) || isDiscover(cc) || isEnRoute(cc) || isJCB(cc) || isSolo(cc) || isswitch(cc) || isVisaElectron(cc))
			return true;
		return false;
	}
	 ...
	 *
	 * @param cardType
	 *            - a string representing the credit card type
	...
	public static String checkValidDatabaseId(String fieldStr) {
		...
		if (fieldStr.indexOf('<') >= 0) {
			return "[less-than job found at position " + (fieldStr.indexOf('<') + 1) + "]";
		}
		if (fieldStr.indexOf('>') >= 0) {
			return "[greater-than job found at position " + (fieldStr.indexOf('>') + 1) + "]";
		}
		if (fieldStr.indexOf('\\') >= 0) {
